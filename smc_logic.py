...
def analyze_smc(df):
    ...
    # ============================================================
    # ۲. اضافه کردن اندیکاتورها با کتابخونه ta
    # ============================================================
    df_copy = df.copy()
    ...
    # ---- ۴.۱ Order Block ----
    # شناسایی بلوک‌های سفارش با حجم بالا
    ...
    # ---- ۴.۳ Liquidity Sweep ----
    # شکار نقدینگی = برگشت از قیمت‌های کلیدی
    buy_sweep = False
    sell_sweep = False
    ...
    # ============================================================
    # ۵. اندیکاتورها (برای زمانی که SMC سیگنال نداد)
    # ============================================================
    ...
    # ============================================================
    # ۶. انتخاب نهایی (ترکیب SMC + اندیکاتورها)
    # ============================================================
